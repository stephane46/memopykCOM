...
import { LogIn, LogOut, Video, Images, MessageCircle, Users, Upload, Eye, EyeOff, FileText, TestTube, Globe, Rocket, Type, BarChart3, HardDrive } from "lucide-react";
...
export default function Admin() {
  ...
  const menuItems = [
    ...
    { 
      id: "video-cache", 
      label: t("Video Cache", { fr: "Cache Vidéo", en: "Video Cache" }), 
      icon: HardDrive 
    },
    { 
      id: "tests", 
